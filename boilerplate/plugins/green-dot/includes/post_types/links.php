...
class gd_link_meta {
	...
	public function render_metabox( $post ) {
		...
		$gd_link_color = get_post_meta( $post->ID, 'gd_link_color', true );
		...
		if( empty( $gd_link_color ) ) $gd_link_color = '';
		...
		echo '	<tr>';
		echo '		<th><label for="gd_link_color" class="gd_link_color_label">' . __( 'Colour', 'fanatic' ) . '</label></th>';
		echo '		<td>';
		echo '			<input type="text" id="gd_link_color" name="gd_link_color" class="gd_link_color_field" placeholder="' . esc_attr__( '', 'fanatic' ) . '" value="' . esc_attr( $gd_link_color ) . '">';
		echo '			<p class="description">' . __( 'Enter hex value of colour', 'fanatic' ) . '</p>';
		echo '		</td>';
		echo '	</tr>';
	...
	public function save_metabox( $post_id, $post ) {
		...
		$gd_new_link_color = isset( $_POST[ 'gd_link_color' ] ) ? sanitize_text_field( $_POST[ 'gd_link_color' ] ) : '';
		...
		update_post_meta( $post_id, 'gd_link_color', $gd_new_link_color );
