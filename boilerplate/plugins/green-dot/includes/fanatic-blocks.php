...
function addFanaticBlock($type="block", $embed=null, $count, $i, $addButton) {
  ...
  if ( $addButton && ( $i < $count || $i == 0 ) && current_user_can( 'edit_posts' ) ) {
...
function gd_remove_yoast_metaboxes(){
...
add_action( 'add_meta_boxes', 'gd_remove_yoast_metaboxes',11 );
